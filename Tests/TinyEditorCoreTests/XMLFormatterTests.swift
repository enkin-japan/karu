...
struct XMLFormatterPrettyPrintTests {
    ...
    func fullPlistDocument() throws {
        ...
        <plist version="1.0"><dict><key>CFBundleName</key><string>TinyEditor</string><key>LSRequiresIPhoneOS</key><true/><key>UIRequiredDeviceCapabilities</key><array><string>armv7</string></array></dict></plist>
        """
        let expected = """
        <?xml version="1.0" encoding="UTF-8"?>
        <!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
